 ...
 *
 * @ViewsStyle(
 *   id = "viewformatterlayoutsdefault",
 *   title = @Translation("view Layout Default"),
 *   help = @Translation("Render default model"),
 *   theme = "view_formatter_layouts_default",
 *   display_types = { "normal" }
 * )
 */
class viewFormatterLayoutsDefault extends StylePluginBase {
  ...
  protected function defaultOptions($model = "cards")
  {
    ...
    if ($model == 'cards') {
      $options = [
        'card_title_field' => 'Titre layout',
        'card_content_field' => 'contenus layout',
        'card_image_field' => 'images layout',
        'card_button_field' => 'buton layout'
      ];
    }
    return $options;
  }
